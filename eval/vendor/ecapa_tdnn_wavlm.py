...
#
# Vendored verbatim from k2-fsa/OmniVoice
# (omnivoice/eval/models/ecapa_tdnn_wavlm.py, Apache-2.0), so that our SIM-o
# is the metric the TTS literature reports rather than one of our own. Paired
# with `speaker_similarity/wavlm_large_finetune.pth` and
# `speaker_similarity/wavlm_large/` from k2-fsa/TTS_eval_models -- the same
# UniSpeech speaker-verification checkpoint that F5-TTS, VALL-E and seed-tts-eval
# score against. Kept unmodified so it can be diffed against upstream.
